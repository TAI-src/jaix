...
class EnvironmentConfig(Config):
    ...
    def __init__(self, 
                 ...
                 suite_config: Config,
                 env_wrappers: Optional[List[Tuple[Type[gym.Wrapper], Union[Config, Dict]]]] = None,
...
class EnvironmentFactory:
    ...
    def get_envs(env_config: EnvironmentConfig):
        ...
        if env_config.comp_config is None:
            ...
            for envs in suite.get_agg_envs(agg_type = comp_config.agg_type, seed = env_config.seed):
                ...
                comp_env = COF.create(comp_config.comp_env_class, comp_config.comp_env_config, wrapped_envs, observation_space = wrapped_envs[0].observation_space, action_space = wrapped_envs[0].action_space)
