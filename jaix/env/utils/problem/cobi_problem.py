...
class CobiProblemConfig(Config):
    ...
    def __init__(
        ...
        peaks_condition_number: Optional[
            Union[float, Tuple[float, float]]
        ] = None,  #  Condition number for Hessian matrices of objective functions.
        ...
        n_constraints: Optional[
            Dict[str, Union[int, Tuple[int, int]]]
        ] = None,  # Dictionary with the number of constraints of each type.
        ...
        quadratic_constraints_size: Union[
            float, Tuple[float, float]
        ...
        quadratic_constraints_condition_number: Optional[
            Union[float, Tuple[float, float]]
        ] = None,  # Condition number for Hessian matrices of quadratic constraints.
        # Follows the same rules as peaks_condition_number.
        n_multi_constraints_groups: Union[
            int, Tuple[int, int]
        ] = 2,  #  Number of groups in each multi-constraint.
        ...
        n_multi_constraints_group_linear: Union[int, Tuple[int, int]] = (
            0,
            1,
        ...
        n_multi_constraints_group_quadratic: Union[int, Tuple[int, int]] = (
            2,
            3,
